let urlHeader = '/api/orders';
app.controller('header-ctrl', function($scope, $http){
	$scope.chon = false;
	$scope.start = 0;
	$scope.totalPage = 0;
	$scope.keyword = "";
    ...
    $scope.create = function(){
		...
		$http.post(urlHeader, data).then(resp => {
